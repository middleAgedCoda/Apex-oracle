...
async function migrate() {
  ...
  // Self-heal: remove any pre-existing pending duplicates before the unique
  // index below is created, or the index creation itself fails on boot.
  await pool.query(`
...
module.exports = {
  pool, migrate, saveEvents, listEvents,updateAnalysisBriefing,
